  ...
  getData() {
    return [
      ...
      [
        ...
        require("../../assets/images/imagine_day/imagine_day_9.jpg"),
        require("../../assets/images/imagine_day/imagine_day_10.jpg"),
        require("../../assets/images/imagine_day/imagine_day_11.jpg"),
        require("../../assets/images/imagine_day/imagine_day_12.jpg"),
        require("../../assets/images/imagine_day/imagine_day_13.jpg"),
      ],
      [
